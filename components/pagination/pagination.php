                            ...
                            <div class="col-sm-6" >
                                <div class="input-group" style="width:100px">
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button" onclick="$(\'#page\').val('.$previous.');form.submit();"> &#10094;</button>
                                    </span>
                                    <input style="padding:6px 0px;text-align:center;" id="page" name="page" type="text" class="form-control" value="'.$page.'" /> 
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button" onclick="$(\'#page\').val('.$next.');form.submit();"> &#10095;</button>
                                    </span>
                                </div></div>
                                <div class="col-sm-5" >
                                 <select style="width:80px" name="limit" class="form-control" onchange="form.submit();">
